...
public class NotesRepositoryImpl implements NotesRepository {
    ...
    public NotesRepositoryImpl() {
        ...
        notes.add(new Note("id2", "Белоголовый сип (Gyps fulvus)",
                ...
                "https://www.niasam.ru/allimages/109816.jpg"));
        notes.add(new Note("id3", "Орёл-карлик (Aquila pennata)",
                ...
                "https://www.niasam.ru/allimages/109817.jpg"));
        notes.add(new Note("id4", "Краснозобый конёк (Anthus cervinus)",
                ...
                "https://www.niasam.ru/allimages/109818.jpg"));
        notes.add(new Note("id5", "Чернолобый сорокопут (Lanius minor)",
                ...
                "https://www.niasam.ru/allimages/109819.jpg"));
        notes.add(new Note("id6", "Обыкновенный скворец (Sturnus vulgaris)",
                ...
                "https://www.niasam.ru/allimages/109820.jpg"));
        notes.add(new Note("id7", "Крапивник (Troglodytes troglodytes)",
                ...
                "https://www.niasam.ru/allimages/109821.jpg"));
        notes.add(new Note("id8", "Пепельная чечётка (Carduelis hornemanni)",
                ...
                "https://www.niasam.ru/allimages/109822.jpg"));
        notes.add(new Note("id9", "Белокрылый клёст (Loxia leucoptera)",
                ...
                "https://www.niasam.ru/allimages/109823.jpg"));
        notes.add(new Note("id10", "Глухая кукушка (Cuculus optatus)",
                ...
                "https://www.niasam.ru/allimages/109824.jpg"));
        notes.add(new Note("id11", "Белая трясогузка (Motacilla alba)",
                ...
                "https://www.niasam.ru/allimages/109825.jpg"));
